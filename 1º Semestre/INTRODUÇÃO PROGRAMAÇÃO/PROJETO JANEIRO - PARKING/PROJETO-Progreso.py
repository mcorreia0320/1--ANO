...
def ordena_historico(dicionario): #Funcção que ordena o dicionario por Hora de Entrada, Hora de Salida, Andar, Lugar e Preço, respetivamente.
    ...
    if menu_a_mostrar == 0: #Menu Principal
        ...
        if opção_escolhida == 0: #Menu Escolha Lugar 1 --> Volta ao Menu Escolha Andar
            ...
            if ocupação_andar_1[opção_escolhida] == ['_','X']: # Caso o lugar se encontre disponivel
                ...
                lugares_ocupados_1 += 1 #Conta os lugares ocupados do andar 1
                lugares_ocupados_geral += 1 #Conta os lugares ocupados em geral
        ...
        if opção_escolhida == 0: #Menu Escolha Lugar 2 --> Volta ao Menu Escolha Andar
            ...
            if ocupação_andar_2[opção_escolhida] == ['_','X']: # Caso o lugar se encontre disponivel
                ...
                lugares_ocupados_2 += 1 #Conta os lugares ocupados do andar 2
                lugares_ocupados_geral += 1 #Conta os lugares ocupados em geral
        ...
        if andar_estacionado == 1:
            ...
            valor_a_pagar = 0.02 * (tempo / 60) #Calcular o valor a pagar, sabendo que este andar cobra 0.02€ por minuto
            ...
            valor_a_pagar = 0.01 * (tempo / 60) #Calcular o valor a pagar, sabendo que este andar cobra 0.01€ por minuto
        ...
        while menu_a_mostrar == 6: #Ciclo para o Menu Pagar
            ...
            if valor_introduzido > valor_a_pagar: # Caso o usuario ja tenha pago o parking
                ...
                if andar_estacionado == 1: #Caso o andar de onde se retira o carro, seja o andar 1
                    ...
                    lugares_ocupados_2 -= 1 #Saida de veiculos presentes no andar 2  
                    lugares_ocupados_geral -= 1 #Conta os lugares ocupados em geral
            ...
            if voltar_ou_moedas == 0: #Volta ao Menu Anterior
                ...
                if voltar_ou_moedas != 0.01 or voltar_ou_moedas != 0.02 or voltar_ou_moedas != 0.05 or voltar_ou_moedas != 0.10 or voltar_ou_moedas != 0.20 or voltar_ou_moedas != 0.50: #Caso introduza um valor não aceite
                    print('')
